...
export type TroubleshootingWorkflowStage = 'INCIDENT' | 'INVESTIGATION' | 'DIAGNOSIS' | 'REMEDIATION' | 'VERIFICATION' | 'COMPLETED';
...
export interface TroubleshootingPostMortem {
    ...
    osiLayer: 'Layer 1 (Physical)' | 'Layer 2 (Data Link)' | 'Layer 1/2 (Physical & Data Link)' | 'Layer 3 (Network)' | 'Layer 4 (Transport)' | 'Layer 3/4 (Network & Transport)' | 'Layer 7 (Application)';
