...
export const EXPANDED_ASSESSMENT_QUESTION_BANK: AssessmentQuestionDef[] = [
  ...
  },
  {
    ...
    options: [
      ...
      '80,000 bits per second (80 kbps)',
      '1 bit per second'
    ],
    correctOption: 0,
    explanation: '1 Byte = 8 bits. If 1 byte is sent every 1 millisecond (1/1000th of a second), then 1,000 bytes are sent in one full second. 1,000 Bytes * 8 bits/Byte = 8,000 bits per second (8 kbps).',
    explanationsJson: {
      1: '1,000 bps accounts for only 1,000 bits, forgetting that 1 byte contains 8 bits.',
      2: '80,000 bps overestimates the rate by a factor of 10.',
      3: '1 bit per second is 8,000 times too slow.'
    },
    difficulty: CourseLevel.FOUNDATIONAL,
    cognitiveLevel: CognitiveLevel.APPLICATION,
    questionType: QuestionType.MULTIPLE_CHOICE,
    concept: 'Data Rate Calculations (Bytes vs Bits)',
    points: 10
  },
