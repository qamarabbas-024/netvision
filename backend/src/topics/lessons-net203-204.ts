...
`,
    ...
    questions: [
      {
        text: 'According to official RFC 5952 rules for IPv6 address representation, what is the correct canonical compressed format for `2001:0db8:0000:0000:0000:0000:0000:0001`?',
        options: [
          '2001:db8::1',
          '2001:0db8::1',
          '2001:db8:0:0:0:0:0:1',
        ...
        correctOption: 0,
        explanation: 'RFC 5952 requires omitting leading zeros in every hextet (`0db8` -> `db8`) and replacing the longest run of contiguous all-zero hextets with a single double-colon `::`, producing `2001:db8::1`.',
        explanationsJson: { 1: 'Retains invalid leading zero.', 2: 'Did not apply double-colon compression.', 3: 'Invalid double use of `::`.' },
        difficulty: CourseLevel.FOUNDATIONAL,
        cognitiveLevel: CognitiveLevel.APPLICATION,
        questionType: QuestionType.MULTIPLE_CHOICE,
        concept: 'RFC 5952 IPv6 Compression Rules',
      },
    ],
    lab: {
      title: 'Guided Practice: IPv6 Zero Compression & SLAAC Interface Verification',
      instructions: '1. Compress 2001:0db8:0000:0000:0000:0000:0000:0001.\n2. Inspect IPv6 addresses with Get-NetIPAddress.',
      difficulty: CourseLevel.FOUNDATIONAL,
      estimatedMinutes: 15,
      initialTopologyJson: { uncompressed: '2001:0db8:0000:0000:0000:0000:0000:0001', compressed: '2001:db8::1' },
      tasks: ['Compress IPv6 address.'],
    },
  },
