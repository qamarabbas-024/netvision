...
export const LESSONS_NET100: BenchmarkLessonFullDefinition[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    contentV2: {
      ...
      workedExample: {
        title: 'Step-by-Step Conversion: Decimal 202 to Binary and Hexadecimal',
        problemStatement: 'Convert the decimal number 202 into an 8-bit binary byte and a 2-digit hexadecimal value.',
        stepByStepSolution: [
          'Step 1 (Decimal to Binary): Compare 202 against the 8 positional weights (128, 64, 32, 16, 8, 4, 2, 1):\n• 202 >= 128? YES -> Bit is 1. Remainder: 202 - 128 = 74.\n• 74 >= 64? YES -> Bit is 1. Remainder: 74 - 64 = 10.\n• 10 >= 32? NO -> Bit is 0. Remainder: 10.\n• 10 >= 16? NO -> Bit is 0. Remainder: 10.\n• 10 >= 8? YES -> Bit is 1. Remainder: 10 - 8 = 2.\n• 2 >= 4? NO -> Bit is 0. Remainder: 2.\n• 2 >= 2? YES -> Bit is 1. Remainder: 2 - 2 = 0.\n• 0 >= 1? NO -> Bit is 0. Remainder: 0.\n-> Binary result: 11001010.',
          'Step 2 (Binary to Hexadecimal): Split 11001010 into two 4-bit nibbles:\n• Left Nibble (1100): 8 + 4 = 12. In hexadecimal, 12 is represented by letter C.\n• Right Nibble (1010): 8 + 2 = 10. In hexadecimal, 10 is represented by letter A.\n-> Hexadecimal result: 0xCA.',
          'Step 3 (Verification): Check: (12 * 16) + (10 * 1) = 192 + 10 = 202. Both conversions match perfectly.',
        ],
        finalResult: 'Decimal 202 = Binary 11001010 = Hexadecimal 0xCA.',
      },
      practice: [
        {
          id: 1,
          ...
          expected: '11000000',
          hints: 'Compare 192 against positional weights: 128 (1), 64 (1), all remaining bits 0.',
        },
        {
          id: 2,
          prompt: 'Convert binary 11111111 into a 2-digit hexadecimal string.',
          expected: 'FF',
          hints: 'Split into nibbles: Left 1111 = 15 (F), Right 1111 = 15 (F).',
        },
        {
          id: 3,
          prompt: 'Convert hexadecimal 0x0A into its decimal value.',
          expected: '10',
          hints: 'In hexadecimal, the letter A represents decimal value 10.',
        },
      ],
      recap: [
