      ...
      <div className="glass-panel p-4 rounded-2xl border border-[#272732] flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="bg-[#121217] text-white border border-[#272732] rounded-xl px-3 py-1.5 text-xs font-mono"
          >
        ...
        <div className="flex items-center gap-1 text-zinc-400">
          <button onClick={() => setZoomLevel((z) => Math.max(0.7, z - 0.1))} className="p-2 rounded-lg hover:bg-white/5">
            <ZoomOut className="w-4 h-4" />
          </button>
          <span className="text-xs font-mono">{Math.round(zoomLevel * 100)}%</span>
          <button onClick={() => setZoomLevel((z) => Math.min(1.5, z + 0.1))} className="p-2 rounded-lg hover:bg-white/5">
            <ZoomIn className="w-4 h-4" />
          </button>
        </div>
      </div>

      {/* Main Interactive Topology Canvas */}
      <div className="relative h-[480px] bg-[#09090b] rounded-3xl border border-[#272732] overflow-hidden flex items-center justify-center p-8">
        <div
