...
export const CurriculumSection: React.FC<CurriculumSectionProps> = ({ onStartLab }) => {
  ...
  const featuredCourses = [
    ...
    {
      code: 'NV-C02',
      slug: 'nv-c02-ethernet-frame-encapsulation-switching-dynamics',
      image: '/courses/net-201.png',
      level: 'INTERMEDIATE',
      levelColor: 'text-[#34d399] bg-[#10b981]/15 border-[#10b981]/30',
      icon: <Terminal className="w-4 h-4 text-[#34d399]" />,
      title: 'Ethernet Frame Encapsulation & Switching Dynamics',
      summary: 'Explore frame structure, MAC table learning dynamics, and modern layer 2 switching principles.',
      bullets: [
    ...
    {
      code: 'NV-C03',
      slug: 'nv-c03-ip-addressing-vlsm-routing-fundamentals',
      image: '/courses/net-301.png',
      level: 'INTERMEDIATE',
      levelColor: 'text-[#34d399] bg-[#10b981]/15 border-[#10b981]/30',
      icon: <Globe className="w-4 h-4 text-[#34d399]" />,
      title: 'IP Addressing, VLSM & Routing Fundamentals',
      summary: 'Master the principles of IPv4 addressing, variable length subnet masks (VLSM), and efficient routing.',
      bullets: [
    ...
    {
      code: 'NV-C04',
      slug: 'nv-c04-transport-layer-reliability-sockets',
      image: '/courses/net-401.png',
      level: 'ADVANCED',
      levelColor: 'text-[#f87171] bg-[#ef4444]/15 border-[#ef4444]/30',
      icon: <Shield className="w-4 h-4 text-[#f87171]" />,
      title: 'Transport Layer Reliability & Sockets',
      summary: 'Deep-dive into TCP state machines, windowing, congestion control, and UDP socket architectures.',
      bullets: [
        'TCP 3-way handshake & 4-way teardown verification',
        'Sliding window flow control & congestion backoff',
      ],
      stepNumber: '04',
    },
  ];
