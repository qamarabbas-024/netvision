...
export const sidebarItems: SidebarItem[] = [
  ...
  { label: 'Admin Panel', href: '/admin', icon: <ShieldAlert className="w-4 h-4" /> },
];
...
export const AppSidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 h-screen sticky top-0 glass-panel border-r border-[#272732]/60 p-4 flex flex-col justify-between shrink-0">
      ...
      {/* Logout Action */}
      <button className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-rose-400 hover:bg-rose-500/10 transition-colors w-full">
